...
//   SM_ACCOUNT        (optional)  Meta ad account, default = W Residences'
...
function readPaidFromSupermetrics(d) {
  ...
  try {
    var payload = {
      ds_id: 'FA',
      ds_accounts: [props.getProperty('SM_ACCOUNT') || 'act_2029551921300421'],
    ...
    var match = props.getProperty('SM_CAMPAIGN_MATCH') || 'WResidences';
    ...
    var total = {
      ch: 'Meta', name: 'TOTAL — W Residences (Meta)',
